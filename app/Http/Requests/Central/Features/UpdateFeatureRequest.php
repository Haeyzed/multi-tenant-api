...
/**
 * Validates payload for updating an existing billable platform feature.
 */
class UpdateFeatureRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
             ...
             * @example advanced-analytics
             */
            'slug' => ['sometimes', 'string', 'max:255', 'alpha_dash', Rule::unique('features', 'slug')->ignore($feature->id)],
             ...
             */
            'key' => ['sometimes', 'string', 'max:255', Rule::unique('features', 'key')->ignore($feature->id)],
