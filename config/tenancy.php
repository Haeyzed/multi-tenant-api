...
return [
    ...
    'bootstrappers' => [
        ...
        // CacheTenancyBootstrapper uses cache tags, which the database/file drivers do not support.
        // With separate tenant databases, CACHE_STORE=database is already isolated per tenant.
        // Re-enable this bootstrapper only when using a taggable store (Redis, Memcached, DynamoDB).
